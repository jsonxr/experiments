import React, { useEffect, useContext, useRef, useState, CSSProperties, forwardRef, ForwardedRef, MutableRefObject } from 'react';
...
export const useCamera = <T extends Camera>(createCameraFn: (scene: Scene) => T, autoAttach: boolean = true, noPreventDefault: boolean = true/*, useCtrlForPanning: boolean = false, panningMouseButton: number*/): Nullable<T> => {
  ...
  }, [autoAttach, createCameraFn, noPreventDefault, scene]);
...
export type SceneComponentProps = {
  ...
  sceneRef?: MutableRefObject<Scene | undefined>
};
